            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="xzoom-container">
                        <img class="xzoom" id="xzoom-default" src="{{asset($product->image)}}" xoriginal="{{asset($product->image)}}" height="300px" width="300px" />
                        <div class="xzoom-thumbs">
                            @foreach($product->otherImages as $otherImage)
                                <a href="{{asset($otherImage->image)}}"><img class="xzoom-gallery" height="100px" width="100px" src="{{asset($otherImage->image)}}"  xpreview="{{asset($otherImage->image)}}" title="The description goes here"></a>
                            @endforeach
                        </div>
                    </div>
                </div>
