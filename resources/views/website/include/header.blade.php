            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="top-end">
                        ...
                        <ul class="user-login">
                            <li>
                                <a href="{{route('customer.index')}}">Sign In</a>
                            </li>
                            <li>
                                <a href="">Register</a>
                            </li>
                            ...
                            <div class="cart-items">
                                ...
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>2 Items</span>
                                        <a href="{{route('cart.php')}}">View Cart</a>
                                    </div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="button">
                                            <a href="{{route('check.out.php')}}" class="btn animate">Checkout</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="nav-inner">
                    ...
                    <div class="mega-category-menu">
                        ...
                        <ul class="sub-category">
                            ...
                            <li>
                                <a href="{{route('category.php',['id' => $category->id])}}">{{$category->Category_Name}}
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a href="r{{route('home.php')}}" class="active" aria-label="Toggle navigation">Home</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu collapse" id="submenu-1-3">
                                        <li class="nav-item"><a href="{{route('category.php',['id'=>$category->id])}}">Shop Grid</a></li>
