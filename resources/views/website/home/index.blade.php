            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}assets/images/featured-categories/fetured-item-2.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}assets/images/featured-categories/fetured-item-3.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}assets/images/featured-categories/fetured-item-4.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}assets/images/featured-categories/fetured-item-5.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}assets/images/featured-categories/fetured-item-6.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('detail.php',['id'=>$product->id])}}">{{$product->name}}</a>
                            </h4>
                            <ul class="review">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    <div class="single-banner right"
                        style="background-image:url('{{asset('/')}}assets/images/banner/banner-3-bg.jpg');margin-top: 30px;">
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            <img src="{{asset('/')}}assets/images/offer/offer-image.jpg" alt="#">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/01.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/02.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/03.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                ...
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/04.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/05.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/06.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/07.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/08.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img src="{{asset('/')}}assets/images/home-product-list/09.jpg" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
            ...
            <div class="brands-logo-wrapper">
                <div class="brands-logo-carousel d-flex align-items-center justify-content-between">
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/01.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/02.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/03.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/04.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/05.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/06.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}assets/images/brands/03.png" alt="#">
                    </div>
