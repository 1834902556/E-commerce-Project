    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal p-t-20" method="post" action="{{route('create.category')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <textarea pe="text" rows="10" class="form-control" id="description" name="description" placeholder="Category Description"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
